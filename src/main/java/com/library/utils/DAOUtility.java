...
public class DAOUtility {
	...
	public static Connection getConnection() throws SQLException {
		// not necessary if it can be found in class path
		try {
...
//		}
//		try {
//			Connection connection = DriverManager.getConnection(CONNECTION_URL,CONNECTION_PASSWORD,CONNECTION_USERNAME);
//			System.out.println("Connectionis valid : " + connection.isValid(5));
//		}catch (SQLException ex) {
//			System.out.println("coconnection failed");
//			ex.printStackTrace();
//		}
//	}
